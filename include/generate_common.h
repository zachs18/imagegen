...
#define GENERATE_HELP \
    ...
    "    -w <int>                            Number of worker threads (doesn't change image,\n" \
    "                                            but higher generally means faster for large images,\n" \
    "                                            up to the limit of number of CPU cores).\n" \
    "    -C <int> --colorcount <int>         Place <int> colors at a time (DOES change image, higher is faster).\n" \
